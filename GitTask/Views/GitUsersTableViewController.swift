...
extension GitUsersTableViewController: UISearchResultsUpdating
{
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let updateOn = (viewModel.userDetailsItems[indexPath.row]["updated_at"] as? String)
        if(updateOn != nil)
        {
       
            cell.updatedOnLabel.text = Dateconversion.dateconversion(date: updateOn!)
        }
         return cell
    }
